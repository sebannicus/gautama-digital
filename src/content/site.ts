...
export const SITE = {
  ...
  description:
    'Diseño web profesional y SEO local para negocios en La Serena y Coquimbo. Resultados reales: +100 visitas orgánicas en 30 días sin invertir en publicidad. Cotiza gratis con Seba.',
