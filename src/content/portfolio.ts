...
export const PORTFOLIO: readonly PortfolioProject[] = [
  ...
  },
  {
    ...
    url: 'simaingenieria.cl',
    href: 'https://www.simaingenieria.cl/',
  ...
  },
  {
    ...
    url: 'salvatierrapaintworks.vercel.app',
    href: 'https://salvatierrapaintworks.vercel.app/',
  ...
  },
  {
    ...
    url: 'constructora-scheidl.vercel.app',
    href: 'https://constructora-scheidl.vercel.app/',
  ...
  },
  {
    id: 'sos-defensa',
    name: 'SOS Defensa',
    industry: 'Jurídico · La Serena & Coquimbo',
    description: 'Landing premium para estudio de abogadas (derecho laboral + familiar + mediación). Diseño dark-gold con chatbot calificador de leads via WhatsApp y 5 páginas de contenido SEO.',
    url: 'sos-defensa.vercel.app',
    href: 'https://sos-defensa.vercel.app',
    tags: ['Landing', 'Legal', 'LeadBot'],
    accentColor: '#C3A75D',
  },
  {
    id: 'hanaq-pacha',
    name: 'Hanaq Pacha',
    industry: 'Pisquera · Vallenar, Atacama',
    description: 'CRM comercial completo para pisquera artesanal. Dashboard con prospección via Google Maps API, gestión de stock, campañas de email y exportaciones — todo en cliente con cifrado AES-256.',
    url: 'hanaq-pacha.vercel.app',
    href: 'https://hanaq-pacha.vercel.app',
    tags: ['CRM', 'Dashboard', 'IA'],
    accentColor: '#7B3252',
  },
];
